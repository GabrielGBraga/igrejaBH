...
function ComboboxInput({
  ...
  return (
    <ComboboxPrimitive.Trigger
      render={<InputGroup className={cn("w-full cursor-pointer", className)} />}
      disabled={disabled}
    >
