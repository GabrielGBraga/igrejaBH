...
export default function Materials() {
    ...
    return (
        <div className="flex min-h-screen bg-background text-foreground selection:bg-primary/20 w-full">
            <Sidebar />
            
            <main className="flex-1 flex flex-col items-start justify-start p-4 md:p-8 overflow-y-auto w-full">
